...
<head>
    ...
    <!-- #favicon -->
    <link rel="shortcut icon" href="./asset/mims.png" type="image/x-icon">
  <!-- Site Metas -->
  <meta name="keywords" content="Welcome To MSSN Islamic Model School Akure" />
  <meta name="description" content="Welcome To MSSN Islamic Model School Akure" />
  <meta name="author" content="MSSN Islamic Model School Akure" />

    <!-- #title -->
    <title> MSSN Islamic Model Schools Akure</title>
...
<body>
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="navbar navbar-expand-xl nav-shadow" id="#navbar">
                        <a class="navbar-brand" href="index.html"><img src="./asset/mims.png" class="logo" alt="logo" style="border-radius: 50%; width:50px; height: 50px;"></a>
                            ...
                            <div class="main-menu">
                                <ul class="navbar-nav mb-lg-0 mx-auto">
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-togle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Home </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a class="nav-link" href="./public/about.php">About</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="./public/signup.php">SignUp/Login</a>
                                    </li>
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Pages </a>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="./public/faq.php">FAQs</a></li>
                                            <li><a class="dropdown-item" href="./public/about.php">About</a></li>
                                ...
                                <div class="nav-right d-none d-xl-block">
                                    <div class="nav-right__search">
                                        ...
                                        <a href="./public/login.php" class="btn_theme btn_theme_active">Get Started <i class="bi bi-arrow-up-right"></i><span></span></a>
                                    </div>
                    ...
                    <div class="custom-nevbar__left">
                        ...
                        <ul class="custom-nevbar__nav mb-lg-0">
                            <li class="menu_item dropdown">
                                <a class="menu_link dropdown-togge" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Home </a>
                    
                            </li>
                            <li class="menu_item dropdown">
                                <a class="menu_link dropdown-tggle" href="./public/about.php" role="button" data-bs-toggle="dropdown" aria-expanded="false"> About Us </a>
                            </li>
                            <li class="menu_item dropdown">
                                <a class="menu_link dropdown-tggle" href="./public/signup.php" role="button" data-bs-toggle="dropdown" aria-expanded="false"> SignUp/Login</a>
                            </li>
                            <li class="menu_item">
                                
                            </li>
                            <li class="menu_item dropdown">
                                <a class="menu_link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> More Pages </a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="./public/about.php">Mission</a></li>
                                    <li><a class="dropdown-item" href="./public/faq.php">Faqs</a></li>
                                </ul>
                            </li>
                            <li class="menu_item">
                                <a class="menu_link" href="./public/contact.php">Contact</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="custom-nevbar__right">
                        <div class="custom-nevbar__top d-none d-md-block">
                            ...
                            <div class="custom-nevbar__right-thumb mb-auto">
                                <p>MSSN ISLAMIC MODEL SCHOOLS AKURE</p>
                            </div>
                        </div>
                        <ul class="custom-nevbar__right-location">
                            <li>
                                <p class="mb-2">Phone: </p>
                                <a href="tel:+2349129324801" class="fs-4 contact">+234900-MIMS</a>
                            </li>
                            <li class="location">
                                <p class="mb-2">Email: </p>
                                <a href="mailto:info@mims.edu.ng" class="fs-4 contact"><span class="__cf_email__"  >info@mims.edu.ng</span></a>
                            </li>
                            <li class="location">
                                <p class="mb-2">Location: </p>
                                <p class="fs-4 contact">MSSN Islamic Model Schools Akure</p>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row gy-5 gy-lg-0 align-items-center justify-content-center justify-content-lg-between">
                <div class="col-12 col-lg-7 col-xxl-6">
                    <div class="section__content">
                        <span class="section__content-sub-title headingFour wow fadeInDown" data-wow-duration="0.8s"><img src="assets/images/title_vector.png" alt="vector"> MIMS AKURE</span>
                        <h1 class="section__content-title display-3 wow fadeInUp" data-wow-duration="1s">Welcome To MSSN Islamic Model Schools</h1>
                        <p class="section__content-text wow fadeInDown" data-wow-duration="0.8s">Where future leaders are nurtured,islamically,morally and academically.</p>
                        <div class="btn-group mt_40 wow fadeInUp" data-wow-duration="0.8s">
                            
                            <a href="./public/login.php" class="btn_theme">Get Started<i class="bi bi-arrow-up-right"></i><span></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-9 col-lg-5 col-xxl-5">
                    <div class="hero--secondary__thumb wow fadeInUp" data-wow-duration="0.8s">
                       <!-- <img src="./asset/itstuff.png" alt="Image">-->
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="section__content">
                        ...
                        <p class="section__content-text wow fadeInDown" data-wow-duration="0.8s">Where future leaders are nurtured,islamically,morally and academically.</p>   
                            ...
                            <div class="card wow fadeInDown" data-wow-duration="0.8s">
                                ...
                                <div class="card__content">
                                    <h4 class="card__title">Advanced Learning</h4>
                                    <p class="fs-small">At MIMS AKURE, we believe in providing advanced learning opportunities that cater to the diverse needs of our students. Our curriculum is designed to challenge and inspire, fostering critical thinking and creativity.</p>
                                </div>
                            </div>
                            <div class="card wow fadeInDown" data-wow-duration="0.8s">
                                <div class="card__icon">
                                ...
                                <div class="card__content">
                                    <h4 class="card__title">Conducive Learning Environment</h4>
                                    <p class="fs-small">At MIMS AKURE, we are committed to providing a conducive learning environment that fosters creativity, collaboration, and innovation. Our state-of-the-art facilities, resources, and support services are designed to enhance the learning experience and help students reach their full potential.</p>
                                </div>
                            </div>
                            <div class="card wow fadeInDown" data-wow-duration="0.8s">
                                <div class="card__icon">
                                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M33.8586 22.6412C34.105 23.5141 34.2367 24.435 34.2367 25.3867C34.2367 30.9571 29.721 35.4727 24.1507 35.4727C21.1376 35.4727 18.4331 34.1515 16.585 32.0566M20.0111 8.36448C19.5936 8.15945 19.0751 8.22955 18.7278 8.57683L17.5344 9.77024C17.2106 10.094 16.7203 10.1918 16.3016 10.0063C16.1715 9.94863 16.0398 9.89413 15.9065 9.84287C15.479 9.67848 15.2015 9.26209 15.2015 8.80415V7.1163C15.2015 6.49874 14.7009 5.99805 14.0833 5.99805H11.536C10.9184 5.99805 10.4178 6.49867 10.4178 7.1163V8.80415C10.4178 9.26216 10.1403 9.67848 9.71285 9.84287C9.57954 9.89413 9.44777 9.94863 9.31769 10.0063C8.89898 10.1918 8.40869 10.0941 8.0849 9.77024L6.89156 8.57676C6.45485 8.14012 5.74687 8.14012 5.31016 8.57676L3.50897 10.378C3.07226 10.8147 3.07226 11.5227 3.50897 11.9594L4.70238 13.1528C5.02617 13.4766 5.1239 13.9669 4.93842 14.3856C4.88076 14.5157 4.82627 14.6474 4.77501 14.7808C4.61062 15.2083 4.19423 15.4857 3.73629 15.4857H2.04829C1.43074 15.4857 0.930115 15.9864 0.930115 16.6039V19.1513C0.930115 19.7688 1.43074 20.2694 2.04829 20.2694H3.73615C4.19416 20.2694 4.61048 20.547 4.77487 20.9744C4.826 
stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M33.3886 10.1797H29.0799C28.1513 10.1797 27.3986 10.9325 27.3986 11.8611C27.3986 12.7897 28.1513 13.5425 29.0799 13.5425H33.3886C34.3172 13.5425 35.07 12.7897 35.07 11.8611C35.07 10.9325 34.3172 10.1797 33.3886 10.1797Z" stroke="#074C3E" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        </g>
                                        <defs>
                                ...
                                <div class="card__content">
                                    <h4 class="card__title">More About MIMS AKURE</h4>
                                    <p class="fs-small">The MIMS AKURE is dedicated to empowering students with practical and theoretical knowledge in various fields. Our programs focus on innovation, problem-solving, and hands-on experience, preparing graduates for successful careers. We foster a collaborative environment, encourage research, and support continuous learning to keep pace with the evolving world.</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row align-items-center justify-content-center justify-content-lg-between gy-5 gy-lg-0">            
                <div class="col-12 col-sm-8 col-lg-6 col-xxl-5 order-1 order-lg-0">
                    <div class="how-works__thumbs unset-xxl-left me-4 me-xxl-0 wow fadeInDown" data-wow-duration="0.8s">
                        <img src="./asset/fcpit.jpg" alt="image" style="border-radius: 5%; width: 100%; height: auto;">
                    </div>
                </div>
                <div class="col-12 col-lg-6 col-xxl-6">
                    <div class="section__content">
                        <span class="section__content-sub-title headingFour wow fadeInDown" data-wow-duration="0.8s"><img src="assets/images/title_vector.png" alt="vector">Create An Account</span>
                        <h2 class="section__content-title wow fadeInUp" data-wow-duration="0.8s">How To Have An Account</h2>
                   
                        <div class="section__content-inner mt_60">
                            <div class="card wow fadeInUp" data-wow-duration="0.8s">
                                <div class="card__icon">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_1102_9225)">
                                        <path d="M2.5 13.75C2.33424 13.75 2.17527 13.8158 2.05806 13.9331C1.94085 14.0503 1.875 14.2092 1.875 14.375V16.875C1.875 17.0408 1.94085 17.1997 2.05806 17.3169C2.17527 17.4342 2.33424 17.5 2.5 17.5H3.86273C4.05873 18.3494 4.38375 19.1637 4.82648 19.9146L3.30805 21.433C3.25001 21.4911 3.20397 21.56 3.17256 21.6358C3.14114 21.7116 3.12498 21.7929 3.12498 21.875C3.12498 21.9571 3.14114 22.0384 3.17256 22.1142C3.20397 22.19 3.25001 22.2589 3.30805 22.317L5.18305 24.192C5.24108 24.25 5.30998 24.296 5.38582 24.3274C5.46165 24.3589 5.54292 24.375 5.625 24.375C5.70708 24.375 5.78835 24.3589 5.86418 24.3274C5.94001 24.296 6.00892 24.25 6.06695 24.192L7.58539 22.6735C8.33629 23.1162 9.15062 23.4413 10 23.6373V25.625C10 25.7908 10.0658 25.9497 10.1831 26.0669C10.3003 26.1842 10.4592 26.25 10.625 26.25H12.8164C13.2167 27.8027 13.9847 29.2363 15.0555 30.4297C16.1263 31.6232 17.4686 32.5415 18.9689 33.1072C20.4693 33.6729 22.0837 33.8694 23.6759 33.6799C25.2681 33.4905 26.7914 32.9209 28.1172 32.019L34.2991 38.2009C34.4733 38.375 34.68 38.5131 34.9074 38.6073
                                        <path d="M18.75 23.75C18.75 23.5842 18.6842 23.4253 18.5669 23.3081C18.4497 23.1908 18.2908 23.125 18.125 23.125C17.9592 23.125 17.8003 23.1908 17.6831 23.3081C17.5658 23.4253 17.5 23.5842 17.5 23.75C17.5015 25.0756 18.0288 26.3465 18.9661 27.2839C19.9035 28.2212 21.1744 28.7485 22.5 28.75C22.6658 28.75 22.8247 28.6842 22.9419 28.5669C23.0592 28.4497 23.125 28.2908 23.125 28.125C23.125 27.9592 23.0592 27.8003 22.9419 27.6831C22.8247 27.5658 22.6658 27.5 22.5 27.5C21.5058 27.4989 20.5526 27.1035 19.8496 26.4004C19.1465 25.6974 18.7511 24.7442 18.75 23.75Z" fill="#074C3E"/>
                                        </g>
                                        <defs>
                                        <clipPath id="clip0_1102_9225">
                                ...
                                <div class="card__content">
                                    ...
                                    <p class="fs-small"> Click on get started button</p>
                                </div>
                            </div>
                            <div class="card wow fadeInUp" data-wow-duration="0.8s">
                                <div class="card__icon">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_1102_9254)">
                                        <path d="M14.8511 26.2504C14.803 25.926 14.5004 25.702 14.1771 25.7503L1.41654 27.6407C1.41013 27.642 1.3996 27.6348 1.3985 27.6273L1.18708 26.2007C1.18647 26.1965 1.18754 26.1922 1.19006 26.1888C1.19258 26.1854 1.19634 26.1831 1.20053 26.1825L13.9614 24.292C14.0385 24.2806 14.1126 24.2541 14.1795 24.2141C14.2463 24.174 14.3046 24.1212 14.3511 24.0586C14.3975 23.996 14.4312 23.9249 14.4501 23.8493C14.469 23.7737 14.4729 23.6951 14.4615 23.618C14.4134 23.2937 14.1109 23.0696 13.7875 23.118L10.1357 23.6589C10.3039 23.3898 10.4242 23.0935 10.4914 22.7833C11.3662 22.7147 12.0574 21.9823 12.0574 21.0902V20.8854C12.0574 20.1158 11.5431 19.4651 10.8404 19.2563V18.4311L12.3949 15.6884C12.4339 15.6206 12.4591 15.5457 12.4691 15.4681C12.479 15.3905 12.4735 15.3117 12.4529 15.2363C12.4323 15.1608 12.3969 15.0902 12.3489 15.0284C12.3009 14.9667 12.2411 14.915 12.1731 14.8764C12.105 14.8379 12.03 14.8131 11.9524 14.8036C11.8747 14.7941 11.796 14.8001 11.7206 14.8212C11.6453 14.8422 11.5749 14.878 11.5134 14.9264C11.4519 14.9748 11.4006 15.0348 11.3625 15.1031L9.79498 17.8684C9.70232 18.0323 9.65358 18.2172 9.65351 18.4055V19.1854H5.17241V18.4055C5.17241 18.2176 5.12351 18.0318 5.03078 17.8682L2.75331 13.85L2.74833 13.8407C2.31664 13.0569 2.08955 12.1666 2.09145 11.2661C2.09778 8.35768 4.46877 5.97585 7.37676 5.95655L7.41339 5.95639C
764 5.54163 14.6452 5.59766 14.4982L6.01361 13.406H8.8166L9.22812 14.4964C9.2707 14.6093 9.34665 14.7065 9.44585 14.7751C9.54504 14.8437 9.66279 14.8804 9.7834 14.8805C9.8794 14.8805 9.97397 14.8572 10.059 14.8126C10.144 14.768 10.2169 14.7035 10.2715 14.6245C10.3261 14.5455 10.3607 14.4545 10.3724 14.3592C10.384 14.2639 10.3724 14.1672 10.3384 14.0774L8.10458 8.15783C8.10239 8.15228 8.10018 8.14674 8.09793 8.14121ZM6.46548 12.2192L7.42144 9.70926L8.36861 12.2192H6.46548ZM32.8782 4.27734H31.1343C31.0564 4.27733 30.9792 4.29268 30.9072 4.32249C30.8352 4.35231 30.7698 4.39602 30.7147 4.45113C30.6596 4.50623 30.6158 4.57166 30.586 4.64366C30.5562 4.71566 30.5409 4.79283 30.5409 4.87076V10.8746C30.5409 11.0319 30.6035 11.1828 30.7148 11.2941C30.826 11.4054 30.9769 11.4679 31.1343 11.468H31.1369C31.1371 11.468 32.7408 11.4609 33.1828 11.4609C34.401 11.4609 35.3923 10.4697 35.3923 9.25138C35.3923 8.50502 35.0198 7.84435 34.4515 7.44414C34.7124 7.10158 34.8534 6.68281 34.8531 6.25224C34.8531 5.16328 33.9672 4.27734 32.8782 4.27734ZM32.8782 5.46418C33.3128 5.46418 33.6663 5.8177 33.6663 6.25224C33.6663 6.68678 33.3128 7.0403 32.8782 7.0403C32.7502 7.0403 31.7277 7.04196 31.7277 7.04196V5.46426L32.8782 5.46418ZM33.1829 10.274C32.9172 10.274 32.2332 10.2766 31.7277 10.2787V8.23078C31.8932 8.23015 33.1829 8.2288 33.1829 8.2288C33.7468 8.2288 34.2055 8.68755 34.2055 9.25146C34.2055 9.81537 33.7468 10.274 33.1829 10.274Z" fill="#074C3E"/>
                                        </g>
                                        <defs>
                                        <clipPath id="clip0_1102_9254">
                                        <rect width="40" height="40" fill="white"/>
                                        </clipPath>
                                        </defs>
                                    </svg>                                
                                ...
                                <div class="card__content">
                                    <h4 class="card__title">Login</h4>
                                    <p class="fs-small">Get Access To Amazing Features...</p>
                                </div>
                            </div>
                            <div class="card wow fadeInUp" data-wow-duration="0.8s">
                                <div class="card__icon">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_1102_9271)">
                                        <path d="M13.9677 15.6139C14.0401 10.0198 7.49543 6.57706 2.97839 9.86597C2.85364 9.95658 2.76964 10.0927 2.7446 10.2448C2.71956 10.397 2.75549 10.5528 2.84461 10.6786C2.93373 10.8045 3.06885 10.8901 3.22067 10.9169C3.37249 10.9438 3.52878 10.9097 3.65564 10.8221C7.41685 8.08479 12.8569 10.9572 12.796 15.614C12.7961 18.8418 10.1911 21.4678 6.989 21.4678C2.70088 21.5218 -0.182202 16.7324 1.82509 12.9373C1.89581 12.799 1.90868 12.6382 1.86087 12.4904C1.81306 12.3426 1.70849 12.2198 1.57016 12.1491C1.43183 12.0783 1.27107 12.0655 1.12324 12.1133C0.97542 12.1611 0.852644 12.2657 0.781924 12.404C-1.62777 16.9623 1.83821 22.704 6.989 22.6394C10.8371 22.6393 13.9677 19.4876 13.9677 15.6139Z" fill="#074C3E"/>
.7479C20.7588 22.1205 21.2398 21.7164 21.8484 21.7164C22.6567 21.7164 22.9435 22.2721 22.9435 22.7479V25.0996C22.9668 25.8728 24.0911 25.8747 24.115 25.0996V23.5569C24.115 22.8181 24.6802 22.5559 25.1642 22.5559C25.5859 22.5559 26.2997 22.7837 26.2997 23.6377V26.1552C26.3213 26.927 27.4474 26.9312 27.471 26.1552ZM17.2531 11.5896C17.094 11.6819 16.9475 11.7944 16.8173 11.9244C12.0482 8.75603 14.2556 1.20149 20.0052 1.17743C27.3023 1.4408 27.8868 11.752 20.6718 12.8461C20.5226 12.3114 20.1846 11.8685 19.694 11.5861C18.9625 11.1651 17.9815 11.1665 17.2531 11.5896Z" fill="#074C3E"/>
                                        </g>
                                        <defs>
                                        <clipPath id="clip0_1102_9271">
                                        <rect width="40" height="40" fill="white"/>
                                        </clipPath>
                                        </defs>
                                    </svg>                             
                                ...
                                <div class="card__content">
                                    <h4 class="card__title">Enjoy The Website</h4>
                                    <p class="fs-small">Explore all features,and manage your account with ease. Enjoy a seamless experience on our platform!</p>
                                </div>
                            </div>
                            
                            <div class="btn-group mt_40 wow fadeInUp" data-wow-duration="0.8s">
                            
                                    <a href="https://wa.me/2347075907232" class="btn_theme">Live On WhatsApp<i class="bi bi-arrow-up-right"></i><span></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10">
                    <div class="section__content text-center">
                        <h2 class="section__content-title wow fadeInUp" data-wow-duration="0.8s">Our Achievements</h2>
                        <p class="section__content-text wow fadeInDown" data-wow-duration="0.8s">We take pride in our accomplishments and the positive impact we've made in the community.</p>
                       <br> <div class="achievements__wrapper wow fadeInUp" data-wow-duration="0.8s">
                            <div class="achievement">
                                <h3 class="achievement__count">300+</h3>
                                <p class="achievement__text">Graduate</p>
                            </div>
                            <br>
                            <div class="achievement">
                                <h3 class="achievement__count">8</h3>
                                <p class="achievement__text">Approved External Exams</p>
                            </div>
                            <br>
                            <div class="achievement">
                                <h3 class="achievement__count">150+</h3>
                                <p class="achievement__text">Awards Won By Our Students</p>
                            </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center justify-content-lg-between align-items-center gy-5 gy-lg-0">
                <div class="col-12 col-md-8 col-lg-5 order-1 order-lg-0">
                    <div class="download-app__thumb me-lg-5 me-xxl-0 wow fadeInDown" data-wow-duration="0.8s">
                       <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FFUDNewsletter%2F&tabs=timeline&width=340&height=500&small_header=true&adapt_container_width=false&hide_cover=true&show_facepile=true&appId" width="340" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
                    </div>
                </div>
                <div class="col-12 col-lg-7 col-xxl-6">
                    <div class="section__content ms-lg-4 ms-xl-0">
                        <span class="section__content-sub-title headingFour wow fadeInDown" data-wow-duration="0.8s"><img src="assets/images/title_vector.png" alt="vector">Read Newsletter</span>
                        <h2 class="section__content-title wow fadeInUp" data-wow-duration="0.8s">Get Our Newsletter Post Here</h2>
                        <p class="section__content-text wow fadeInDown" data-wow-duration="0.8s">Our Newsletter Page Is Intregated Here For Easier Access To Updates</p>
                        <ul class="section__content-list wow fadeInUp" data-wow-duration="0.8s">
                            <li class="headingFive">Get the latest updates</li>
                            <li class="headingFive">Exclusive offers and news</li>
                            <li class="headingFive">Easy subscription and unsubscribe</li>
                            <li class="headingFive">Delivered directly to your inbox</li>
                        </ul>
                       <!-- <div class="btn-group mt_40 wow fadeInDown" data-wow-duration="0.8s">
                            <a href="https://github.com/Coach-Bamie/app.bamiedata/releases/download/v1.0/Bamiedata_1_1.0.1.apk" class="btn_theme">
                            ...
                            <a href="https://sabuss.com/bamiedata2?login" class="btn_theme">
                    ...
                    <div class="accordion wow fadeInDown" data-wow-duration="0.8s" id="faq">
                        <div class="accordion-item accordion_bg">
                            ...
                            <div id="faq-accordion-1" class="accordion-collapse collapse show" data-bs-parent="#faq">
                                <div class="accordion-body">
                                    <p class="mb-0">MIMS stands for MSSN ISLAMIC MODELS SCHOOLS. It is a comprehensive platform designed to manage and streamline various administrative and academic processes within an educational institution.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h5 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-accordion-2" aria-expanded="true" aria-controls="faq-accordion-2"> 
                                   How can i get student form?
                                </button>
                            </h5>
                            <div id="faq-accordion-2" class="accordion-collapse collapse" data-bs-parent="#faq">
                                <div class="accordion-body">
                                    <p class="mb-0">
                                        You can obtain the student form by visiting the admissions office or downloading it from the official school website.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="faq-accordion-3" class="accordion-collapse collapse" data-bs-parent="#faq">
                                <div class="accordion-body">
                                    <p class="mb-0">
                                        The school is located at Medinah community Ilere Akure & Akure High School & Omieja Annex Akure High School Area akure.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h5 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-accordion-4" aria-expanded="true" aria-controls="faq-accordion-4"> 
                                    Do your school offer islamic education?
                                </button>
                            </h5>
                            <div id="faq-accordion-4" class="accordion-collapse collapse" data-bs-parent="#faq">
                                <div class="accordion-body">
                                    <p class="mb-0">
                                        Yes, our school offers Islamic education as part of our curriculum. We believe in providing a well-rounded education that includes both secular and religious studies.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="about-company wow fadeInLeft" data-wow-duration="0.8s">
                        <div class="footer__logo mb-4">
                            <a href="index.html">
                                <img src="./asset/mims.png" alt="Logo" style="width: 50px; height: 50px; border-radius: 50%;">
                            </a>
                        </div>
                        <p>We are committed to providing quality western and islamic education that is rooted in Islamic values and principles.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer__contact ms-sm-4 ms-xl-0 wow fadeInUp" data-wow-duration="0.8s">
                        ...
                        <div class="footer__content">
                            <a href="tel:+2349129324801"> <span class="btn_theme social_box"> <i class="bi bi-telephone-plus"></i> </span>+2349129324801 <span></span> </a> 
                            
                            <a href="#"> <span class="btn_theme social_box"> <i class="bi bi-geo-alt"></i> </span>MSSN ISLAMIC MODEL SCHOOL AKURE<span></span> </a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-xl-3">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="footer__copyright">
                        <p class="copyright text-center">Copyright © <span id="copyYear"></span> <a href="#" class="secondary_color">MIMS AKURE</a>. Dev By <a href="https://ibrahimbami.onrender.com/" class="secondary_color">Bamiedev</a></p>
                        <ul class="footer__copyright-conditions">
                            <li><a href="https://wa.me/2349129324801">Help & Support</a></li>
    ...
    <!-- jquery -->
    <script data-cfasync="false" src="https://pixner.net/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets/vendor/jquery/jquery-3.6.3.min.js"></script>
    <!-- bootstrap five js -->
